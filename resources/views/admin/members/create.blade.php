...
@section('content')
    <div class="dashboard-hero mb-4">
        <div class="row align-items-center g-4">
            <div class="col-lg-8">
                <span class="dashboard-hero-badge">{{ db_trans('add_member') }}</span>
                <h2 class="dashboard-title mb-2">{{ db_trans('add_member') }}</h2>
                <p class="dashboard-subtitle mb-0">
                    {{ db_trans('register_new_member_into_the_system') }}
                </p>
            </div>

            <div class="col-lg-4 text-lg-end">
                <a href="{{ route('members.index') }}" class="btn btn-outline-light btn-lg">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="gender" class="form-select">
                                    ...
                                    <option value="Male" @selected(old('gender') === 'Male')>{{ db_trans('male') }}</option>
                                    <option value="Female" @selected(old('gender') === 'Female')>{{ db_trans('female') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="family_role" class="form-select">
                                    ...
                                    <option value="Father" @selected(old('family_role') === 'Father')>{{ db_trans('father') }}</option>
                                    <option value="Mother" @selected(old('family_role') === 'Mother')>{{ db_trans('mother') }}</option>
                                    <option value="Child" @selected(old('family_role') === 'Child')>{{ db_trans('child') }}</option>
                                    <option value="Other" @selected(old('family_role') === 'Other')>{{ db_trans('other') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="familia_id" class="form-select" required>
                                    ...
                                    @foreach($familias as $familia)
                                        <option value="{{ $familia->id }}" @selected((string) old('familia_id') === (string) $familia->id)>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="bahasha" class="form-control" value="{{ old('bahasha') }}">
                            </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_baptized" value="1" id="is_baptized" @checked(old('is_baptized'))>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="has_communion" value="1" id="has_communion" @checked(old('has_communion'))>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="has_confirmation" value="1" id="has_confirmation" @checked(old('has_confirmation'))>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="receives_eucharist" value="1" id="receives_eucharist" @checked(old('receives_eucharist'))>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_married" value="1" id="is_married" @checked(old('is_married'))>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="marriage_type" class="form-control" value="{{ old('marriage_type') }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">{{ db_trans('member_code') }}</label>
                                <input type="text" name="member_code" class="form-control" value="{{ old('member_code') }}" placeholder="{{ db_trans('auto_generated_if_left_blank') }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">{{ db_trans('baptism_certificate_number') }}</label>
                                <input type="text" name="baptism_certificate_number" class="form-control" value="{{ old('baptism_certificate_number') }}">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="baptism_parish" class="form-control" value="{{ old('baptism_parish') }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">{{ db_trans('baptism_diocese') }}</label>
                                <input type="text" name="baptism_diocese" class="form-control" value="{{ old('baptism_diocese') }}">
                            </div>
                        </div>
                    </div>
                </div>
