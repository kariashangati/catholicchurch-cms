@php
    $item = $item ?? null;
    $statusOptions = \App\Models\CashContribution::availableStatuses();

    $selectedStatus = old(
        'status',
        $item
            ? \App\Models\CashContribution::normalizeStatus($item->status ?? null)
            : \App\Models\CashContribution::STATUS_APPROVED
    );
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input
                                type="text"
                                class="form-control js-member-search"
                                id="{{ $modalSearchId }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="member_id" class="form-select js-member-select" id="{{ $modalMemberSelectId }}" required>
...
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.js-member-search').forEach(function (input) {
