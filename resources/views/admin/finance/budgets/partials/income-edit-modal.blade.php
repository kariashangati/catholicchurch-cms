<div class="modal fade" id="editIncomeBudgetModal{{ $record->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="{{ route('finance.budgets.income.update', $record) }}">
                @csrf
                @method('PUT')

                <div class="modal-header">
                    <h5 class="modal-title">{{ db_trans('edit_income_budget_estimate') }}</h5>
