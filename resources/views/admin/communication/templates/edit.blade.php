...
@section('title', db_trans('communication.templates.edit_title'))
...
<div class="communication-templates-page">
    <div class="dashboard-hero communication-hero mb-4">
        ...
        <div class="row align-items-center g-4 position-relative">
            <div class="col-lg-8">
                ...
                <h2 class="dashboard-title mb-2">{{ db_trans('communication.templates.edit_title') }}</h2>
                <p class="dashboard-subtitle mb-3">{{ $template->name }}</p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.communication.templates.update', $template) }}">
        @csrf
        @method('PUT')
        @include('admin.communication.templates.partials_form', ['submitLabel' => db_trans('communication.templates.update_action')])
    </form>
</div>
@endsection
