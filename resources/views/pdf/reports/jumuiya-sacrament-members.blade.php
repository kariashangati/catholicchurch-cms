        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 20%;">{{ db_trans('member') }}</th>
                    <th style="width: 16%;">{{ db_trans('familia') }}</th>
                    <th style="width: 10%;">{{ db_trans('gender') }}</th>
                    ...
                    <th class="text-center" style="width: 10%;">{{ db_trans('receiving_eucharist') }}</th>
                </tr>
            </thead>
            <tbody>
                @forelse($rows as $row)
