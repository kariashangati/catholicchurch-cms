    ...
    <section class="auth-card-wrap">
        ...
        <form method="POST" action="{{ route('login') }}" class="auth-form-card">
            ...
            <div class="auth-field">
                <x-input-label for="login" :value="db_trans('email_or_phone')" class="auth-label" />
                <x-text-input
                    id="login"
                    class="auth-input"
                    type="text"
                    ...
                    placeholder="name@example.com / 07XXXXXXXX"
                />
            ...
            <div class="auth-field">
                ...
                <div class="auth-password-wrap">
                    <x-text-input
                        ...
                        placeholder="••••••••"
                    />
                    <button type="button" class="auth-toggle-password" data-toggle-password="#password">
                        {{ db_trans('show') }}
                    </button>
                </div>
