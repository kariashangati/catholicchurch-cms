@php
    $adminTheme = session('admin_theme', auth()->user()->admin_theme ?? 'classic');
    $adminTheme = in_array($adminTheme, ['classic', 'light', 'dark'], true) ? $adminTheme : 'classic';
@endphp
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/css/admin-theme-switcher.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/css/admin-compact-hero.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('admin/css/access-standard-hero-fix.css') }}">
     <link rel="stylesheet" href="{{ asset('admin/css/admin-header-clean-theme-ui.css') }}">

    @stack('styles')
</head>
<body class="admin-body admin-theme-{{ $adminTheme }}" data-admin-theme="{{ $adminTheme }}">
...
<script>
    ...
    <script src="{{ asset('admin/js/admin-theme-switcher.js') }}"></script>
