            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                <div class="flex items-center gap-2">
                    <a href="{{ route('lang.switch', 'en') }}"
                       class="px-3 py-1 rounded text-sm {{ app()->getLocale() === 'en' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                        EN
                    </a>

                    <a href="{{ route('lang.switch', 'sw') }}"
                       class="px-3 py-1 rounded text-sm {{ app()->getLocale() === 'sw' ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                        SW
                    </a>
                </div>
