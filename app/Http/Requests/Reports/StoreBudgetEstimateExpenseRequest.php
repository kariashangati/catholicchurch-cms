...
class StoreBudgetEstimateExpenseRequest extends FormRequest
{
    ...
    {
        return [
            'category_code' => ['required', 'string', 'max:50', Rule::in(BudgetEstimateService::allowedExpenseSourceCodes())],
