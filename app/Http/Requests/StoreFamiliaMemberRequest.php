...
class StoreFamiliaMemberRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('familias.members.create') ?? false;
    }
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'form_context' => $this->input('form_context', 'member_create'),
        ]);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'member_code' => ['nullable', 'string', 'max:100', 'unique:members,member_code'],
